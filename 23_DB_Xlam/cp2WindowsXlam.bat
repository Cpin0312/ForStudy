...
REM echo f | XCOPY ".\createSql_Spc.xlam" "%AppData%\Microsoft\Excel\XLSTART\createSql_Spc.xlam" /E /K /Q /R /Y /D
    echo f | XCOPY ".\voyagerSPC.xla" "%AppData%\Microsoft\Excel\XLSTART\voyagerSPC.xla" /E /K /Q /R /Y /D
